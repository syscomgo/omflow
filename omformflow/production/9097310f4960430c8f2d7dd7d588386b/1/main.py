...
flow_uuid = '9097310f4960430c8f2d7dd7d588386b'
version = 1
def main(data):
    ...
    if chart_id == 'FITEM_1':
        ...
        try:
            ...
            data['error'] = False
            if chart_input['ap_success'] != 'success':
