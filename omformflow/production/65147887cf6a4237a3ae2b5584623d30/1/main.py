...
flow_uuid = '65147887cf6a4237a3ae2b5584623d30'
version = 1
def main(data):
    ...
    if chart_id == 'FITEM_1':
        ...
        data_FITEM_10 = json.loads(data_str)
        data_FITEM_10['chart_id_to'] = 'FITEM_10'
        OmEngine(flow_uuid,data_FITEM_10).checkActive()
