# Generated by Django 2.2 on 2020-08-14 18:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='create_dc33fb340034418c8fbb3baf15525e86', to=settings.AUTH_USER_MODEL, to_field='username', verbose_name='開單人員')),
                ('init_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='extra_data', to='omformmodel.Omdata_dc33fb340034418c8fbb3baf15525e86', verbose_name='初始資料')),
                ('update_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='update_dc33fb340034418c8fbb3baf15525e86', to=settings.AUTH_USER_MODEL, to_field='username', verbose_name='更新人員')),
            ],
            options={
