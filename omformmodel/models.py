...
#<Omdata_1471d897853e4f02a95972c3487148f8 start>
#2
class Omdata_1471d897853e4f02a95972c3487148f8(models.Model):
    table_name = _('generate data fro envifoment')
    flow_uuid = models.UUIDField(verbose_name= _('流程編號'), null=True, blank=True)
    dataid_header = models.CharField(verbose_name= _('資料代碼'), max_length=3)
    data_no = models.IntegerField(verbose_name = _('資料編號'), null=True, blank=True)
    history = models.BooleanField(verbose_name = _('歷史資料'), default=False)
    ...
    updatetime = models.DateTimeField(verbose_name = _('更新時間'), auto_now=True)
    stoptime = models.DateTimeField(verbose_name = _('停止時間'), null=True,blank=True)
    create_user = models.ForeignKey('omuser.OmUser', verbose_name = _('開單人員'), to_field='username', on_delete=models.SET_NULL, blank=True, null=True, related_name='create_1471d897853e4f02a95972c3487148f8')
    update_user = models.ForeignKey('omuser.OmUser', verbose_name = _('更新人員'), to_field='username', on_delete=models.SET_NULL, blank=True, null=True, related_name='update_1471d897853e4f02a95972c3487148f8')
    data_param = models.TextField(verbose_name = _('流程參數'), null=True,blank=True)
    error_message = models.TextField(verbose_name = _('錯誤訊息'), null=True,blank=True)
    init_data = models.ForeignKey('self', blank=True, null=True, related_name='extra_data', verbose_name = _('初始資料'), on_delete=models.CASCADE)
    is_child = models.BooleanField(verbose_name = _('子單'), default=False)
    ...
    class Meta:
        default_permissions = ()
        permissions = (
            ('Omdata_1471d897853e4f02a95972c3487148f8_Add', _('新增generate data fro envifoment')),
            ('Omdata_1471d897853e4f02a95972c3487148f8_Modify', _('修改generate data fro envifoment')),
            ('Omdata_1471d897853e4f02a95972c3487148f8_View', _('檢視generate data fro envifoment')),
            ('Omdata_1471d897853e4f02a95972c3487148f8_Delete', _('刪除generate data fro envifoment')),
        )

class Omdata_1471d897853e4f02a95972c3487148f8_ValueHistory(models.Model):
    flow_uuid = models.UUIDField(verbose_name= _('流程編號'), null=True, blank=True)
    data_no = models.IntegerField(verbose_name = _('資料編號'), null=True, blank=True)
    data_id = models.IntegerField(verbose_name = _('多重資料編號'), blank=True, null=True)
    chart_id = models.CharField(verbose_name= _('功能點'), max_length=500,null=True, blank=True)
...
class Omdata_1471d897853e4f02a95972c3487148f8_DataNo(models.Model):
    createtime = models.DateTimeField(verbose_name = _('建立時間'), auto_now_add=True)
    objects = FormatManager()
    class Meta:
        default_permissions = ()
#<Omdata_1471d897853e4f02a95972c3487148f8 end>
#<new here>
