...
#<Omdata_8b4b0956d31c435f8efb831d87acb2b2 start>
#7
class Omdata_8b4b0956d31c435f8efb831d87acb2b2(models.Model):
    table_name = _('任務單')
    ...
    status = models.CharField(verbose_name= _('狀態'), max_length=20,null=True, blank=True)
    title = models.CharField(verbose_name= _('標題'), max_length=20,null=True, blank=True)
    level = models.CharField(verbose_name= _('燈號'), max_length=20,null=True, blank=True)
    group = models.CharField(verbose_name= _('受派群組'), max_length=20,null=True, blank=True)
    ...
    create_user = models.ForeignKey('omuser.OmUser', verbose_name = _('開單人員'), to_field='username', on_delete=models.SET_NULL, blank=True, null=True, related_name='create_8b4b0956d31c435f8efb831d87acb2b2')
    update_user = models.ForeignKey('omuser.OmUser', verbose_name = _('更新人員'), to_field='username', on_delete=models.SET_NULL, blank=True, null=True, related_name='update_8b4b0956d31c435f8efb831d87acb2b2')
    ...
    class Meta:
        default_permissions = ()
        permissions = (
            ('Omdata_8b4b0956d31c435f8efb831d87acb2b2_Add', _('新增任務單')),
            ('Omdata_8b4b0956d31c435f8efb831d87acb2b2_Modify', _('修改任務單')),
            ('Omdata_8b4b0956d31c435f8efb831d87acb2b2_View', _('檢視任務單')),
            ('Omdata_8b4b0956d31c435f8efb831d87acb2b2_Delete', _('刪除任務單')),
        )

class Omdata_8b4b0956d31c435f8efb831d87acb2b2_ValueHistory(models.Model):
    flow_uuid = models.UUIDField(verbose_name= _('流程編號'), null=True, blank=True)
    data_no = models.IntegerField(verbose_name = _('資料編號'), null=True, blank=True)
    data_id = models.IntegerField(verbose_name = _('多重資料編號'), blank=True, null=True)
    chart_id = models.CharField(verbose_name= _('功能點'), max_length=50,null=True, blank=True)
    stop_chart_type = models.TextField(verbose_name = _('關卡類型'), blank=True, null=True)
    stop_chart_text = models.TextField(verbose_name = _('關卡名稱'), blank=True, null=True)
...
class Omdata_8b4b0956d31c435f8efb831d87acb2b2_DataNo(models.Model):
    createtime = models.DateTimeField(verbose_name = _('建立時間'), auto_now_add=True)
    objects = FormatManager()
    class Meta:
        default_permissions = ()
#<Omdata_8b4b0956d31c435f8efb831d87acb2b2 end>
#<new here>
