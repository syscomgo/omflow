    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_name', models.CharField(blank=True, max_length=20, null=True, verbose_name='顯示名稱')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(blank=True, max_length=20, null=True, verbose_name='部門名稱')),
                ('company', models.CharField(blank=True, max_length=20, null=True, verbose_name='公司名稱')),
                ('ad_flag', models.BooleanField(default=False, verbose_name='AD標記')),
                ('ad_sid', models.CharField(blank=True, max_length=50, null=True, verbose_name='AD_SID')),
